...
namespace NTH.TravelAPI.Controllers.Website.ServiceContact
{
    ...
    [ApiController]
    public class HomeServiceContactController : ControllerBase
    {
        private readonly DapperContext _dapper;

        public HomeServiceContactController(DapperContext dapper)
        {
            _dapper = dapper;
        }
        ...
        {
            var procedureName = "Proc_ServiceContact_GetInfo";
