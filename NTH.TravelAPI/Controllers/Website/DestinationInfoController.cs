...
namespace NTH.TravelAPI.Controllers.Website
{
    ...
    [ApiController]
    public class DestinationInfoController : ControllerBase
    {
        private readonly DapperContext _dapper;

        public DestinationInfoController(DapperContext dapper)
        {
            _dapper = dapper;
        }
        ...
        {
            var procedureName = "Proc_DestinationInfo_GetInfo";
